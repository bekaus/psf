...
class MSPP_EXPORT PeakShapeFunctionTemplate : public PeakShapeFunction
{
public:
    virtual PeakShapeFunctionTemplate* clone() const;
    virtual double operator()(const double referenceMass, const double observedMass) const;
    virtual double getSupportThreshold(const double mz) const;
    virtual PeakShapeFunctionType getType();
...
PeakShapeFunctionTemplate<PeakShapeT, PeakParameterT, PeakShapeFunctionTypeT>::
clone() const {
    PeakShapeFunctionTemplate* cloned = new PeakShapeFunctionTemplate<PeakShapeT, PeakParameterT, PeakShapeFunctionTypeT>(*this);
    return cloned;
}
